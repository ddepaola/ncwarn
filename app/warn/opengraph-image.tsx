...
export const alt = 'WARN Act Layoff Notices - North Carolina';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Track Worker Adjustment and Retraining Notification (WARN) Act
            layoff notices across North Carolina
          </div>
        </div>
