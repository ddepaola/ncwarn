...
export default async function CheckPage({ searchParams }: PageProps<"/check">) {
  const { lookup, radius: radiusParam, range: rangeParam, view: viewParam } = await searchParams;
  ...
  return (
    <div className="space-y-6">
      ...
      <CrimeCard sources={crimeSources} stats={crimeStats} lookupId={row.publicId} radius={radius} range={range} nonCmpdMunicipality={nonCmpdMunicipality} view={view} />
